...
* **Key Highlights:**
    * Hamiltonian $\hat{h}_k$ near Dirac points and the role of mass parameters $\Delta$ and $B$.
...
* **Key Highlights:**
    * Derivation of the edge mode energy: $E(k) = -sgn(m) \hbar v k$.
...
* **Key Highlights:**
    * Relation of Hall conductivity $\sigma_{xy}$ to the Chern number $C$ via the Kubo formula.
...
* **Key Highlights:**
    * Implementation of the Landauer-Büttiker formula for chiral (unidirectional) vs. helical (spin-momentum locked) modes.
